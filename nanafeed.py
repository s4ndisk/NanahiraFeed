...
async def xtwitter_webhook():
  ...
  while True:
    ...
    if tweet_id and tweet_id != latest_tweet_id:
      webhook = DiscordWebhook(url="https://discord.com/api/webhooks/1232155727229882491/BEQfpfu57WQZEahpppK6Af4JKxlm4XWFXImBoWTZWjOdqwY4YbUleR2Gbo9SyuSIMHRE", content=f"ななひら just tweeted!\n\nhttps://twitter.com/nanafeed_/status/{tweet_id}")
      webhook.execute()
